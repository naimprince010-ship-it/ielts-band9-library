...
/**
 * "Practice & Recap" accordion for the writing workspace template — same
 * structure and reused components as `GrammarPracticePanel`
 ...
 */
export function WritingPracticePanel({ commonMistakes, miniPractice, answerKey, quickRecap }: WritingPracticePanelProps) {
  return (
            ...
            <CardContent className="grid gap-4 md:grid-cols-[1fr_260px]">
              ...
              <div className="rounded-2xl border border-white/15 bg-white/10 p-4">
                ...
                <p className="mt-2 text-sm leading-6 text-indigo-100">
                  Content and structure come first. Polish grammar and vocabulary in your final proofread pass.
                </p>
              </div>
            </CardContent>
          </Card>
